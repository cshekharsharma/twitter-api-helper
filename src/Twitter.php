...
final class Twitter {
    ...
    /**
     * Set getfield string, example: '?screen_name=cshekhar_sharma'
     *
     ...
     */
    private function buildAuthorizationHeader($oauthDetails) {
        $return = 'Authorization: OAuth ';
        $values = array();

        foreach($oauthDetails as $key => $value) {
